...
const Cart = () => {
    ...
    const handleRemove = (index) => {
        axios.delete("https://bookkart-server.onrender.com/user/deletecart", {
    ...
    useEffect(() => {
        const fetchCartItems = async () => {
            if (user && user._id) {
                try {
                    const response = await axios.get(`https://bookkart-server.onrender.com/user/getcart/${user._id}`);
